...
export class NativePiperTTS implements TTSPipeline {
  ...
  async synthesize(text: string): Promise<AudioPlayable> {
    ...
    return new BufferedAudioPlayable(float32, 22050);
  }
